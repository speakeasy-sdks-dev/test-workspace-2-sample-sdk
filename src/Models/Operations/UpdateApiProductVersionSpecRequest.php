...
class UpdateApiProductVersionSpecRequest
{
    ...
    public \test_workspace-2\Konnect-API\Models\Shared\UpdateAPIProductVersionSpecDTO $updateAPIProductVersionSpecDTO;
	...
	{
		$this->updateAPIProductVersionSpecDTO = new \test_workspace-2\Konnect-API\Models\Shared\UpdateAPIProductVersionSpecDTO();
		$this->apiProductId = "";
