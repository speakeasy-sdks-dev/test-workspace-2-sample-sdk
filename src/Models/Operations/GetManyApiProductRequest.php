...
class GetManyApiProductRequest
{
     ...
     * 
     * @var ?\test_workspace-2\Konnect-API\Models\Shared\APIProductFilterParameters $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?\test_workspace-2\Konnect-API\Models\Shared\APIProductFilterParameters $filter = null;
